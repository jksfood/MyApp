package com.info.aegis.myapplication.service;
...
public class GetWeChatNotificationService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        try {
            ...
            Toast.makeText(GetWeChatNotificationService.this, "不可解析的通知", Toast.LENGTH_SHORT).show();
        }
